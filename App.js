...
function App()
{
  ...
  const submitReview=()=>
  {
    Axios.post('https://localhost:9000/aliens',
    {name:sname,
    tech:tech,
    sub:status}).then(()=>
    {
  ...
  return(
    <div className="App">
      ...
      <div className="information">
        ...
        <input type="text" name="sname" onChange={(e)=>{setStudentsName(e.target.value);
        }}
        required/>
        <label><b>Technology</b></label>
        <input type="text" name="tech" onChange={(e)=>{setTechnology(e.target.value);
        }}
        required/>
